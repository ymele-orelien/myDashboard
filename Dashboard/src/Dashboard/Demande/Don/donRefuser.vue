<template>
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Prelevement rejeter</li>
          </ol>
        </nav>
      </div>
      <div class="card">
        <div class="card-header">
          <h4>
            <i class="fa-solid fa-calendar"></i> Prelevement rejeter
  ...
  export default {
    ...
    methods: {
      getDonate() {
        axios
          .get("http://127.0.0.1:8000/api/list/Donate/Refuser", {
            headers: {
