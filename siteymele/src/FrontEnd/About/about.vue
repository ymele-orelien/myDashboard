		...
		<div class="container">
			<div class="row">
				<div class="col-lg-2 col-md-4 col-6">
					<img src="../../assets/images/deidoLogo.png" class="img-fluid" alt="" data-aos="zoom-in" />
				</div>

				<div class="col-lg-2 col-md-4 col-6">
					<img src="../../assets/images/hGy.png" class="img-fluid" alt="" data-aos="zoom-in"
						data-aos-delay="100" />
				</div>

				<div class="col-lg-2 col-md-4 col-6">
					<img src="../../assets/images/HR-gAROUA.jpeg" class="img-fluid" alt="" data-aos="zoom-in"
						data-aos-delay="200" />
				</div>

				<div class="col-lg-2 col-md-4 col-6">
					<img src="../../assets/images/biyem-assi.jpeg" class="img-fluid" alt="" data-aos="zoom-in"
						data-aos-delay="300" />
				</div>

				<div class="col-lg-2 col-md-4 col-6">
					<img src="../../assets/images/c-stTHerese.jpeg" class="img-fluid" alt="" data-aos="zoom-in"
						data-aos-delay="400" />
				</div>

				<div class="col-lg-2 col-md-4 col-6">
					<img src="../../assets/images/clinique douala.jpeg" class="img-fluid" alt="" data-aos="zoom-in"
						data-aos-delay="500" />
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row content">
				...
				<div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
					...
					<a href="#services" class="btn-learn-more">services</a>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				<div class="image col-xl-5 d-flex align-items-stretch justify-content-center justify-content-xl-start"
					...
					<img src="../../assets/images/about/counts-img.svg" alt="" class="img-fluid" />
				</div>
			...
			<div class="row">
				<div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
					<div class="icon-box" data-aos="fade-up" data-aos-delay="100">
						...
						<h4 class="title"><a href="">DON DE SANG</a></h4>
						<p class="description">
				...
				<div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
					<div class="icon-box" data-aos="fade-up" data-aos-delay="200">
						...
						<h4 class="title"><a href="">DEMANDE EN POCHE DE SANG </a></h4>
						<p class="description">
				...
				<div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
					<div class="icon-box" data-aos="fade-up" data-aos-delay="300">
						...
						<h4 class="title"><a href="">PARTENERIATS</a></h4>
						<p class="description">
				...
				<div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
					<div class="icon-box" data-aos="fade-up" data-aos-delay="400">
						...
						<h4 class="title"><a href="">EVENEMENTS</a></h4>
						<p class="description">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 d-flex align-items-stretch">
					<div class="card card-img-1" data-aos="fade-up" data-aos-delay="100">
						<div class="card-body">
							<h5 class="card-title"><a href="">DONATION DE POCHE</a></h5>
							<p class="card-text">
				...
				<div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
					<div class="card card-img-2" data-aos="fade-up" data-aos-delay="200">
						<div class="card-body">
							<h5 class="card-title"><a href="">DEMANDE DE POCHES</a></h5>
							<p class="card-text">
				...
				<div class="col-md-6 d-flex align-items-stretch mt-4">
					<div class="card card-img-3" data-aos="fade-up" data-aos-delay="100">
						<div class="card-body">
							<h5 class="card-title"><a href="">PARTENARIATS</a></h5>
							<p class="card-text">
				...
				<div class="col-md-6 d-flex align-items-stretch mt-4">
					<div class="card card-img-4" data-aos="fade-up" data-aos-delay="200">
						<div class="card-body">
							<h5 class="card-title"><a href="">EVENEMENTS</a></h5>
							<p class="card-text">
	...
	<section id="contact" class="contact">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12" data-aos="fade-up" data-aos-delay="300" v-if="isLoggedIn">
					<form action="#" method="post" @submit.prevent="avis_register()">
						<div class="text mb-4">
							<h3 class="mb-4" style="color: #ff2770;">
								N ayait pas peur <br />
								de donner votre avis
							</h3>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magni
								accusantium esse culpa labore deleniti atque pariatur dolore at
								eum maxime, debitis sunt? Mollitia cupiditate ex provident
								nulla. Aperiam, consectetur? Dicta!
							</p>
						</div>
...
.card-img-4 {
	background-image: url("../../assets/images/slideC.jpg");
}
