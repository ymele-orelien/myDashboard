    ...
    <div class="nav">
      <nav>
        ...
        <div class="lien">
          ...
          <span><router-link to="response" v-if="isLoggedIn">Reponse</router-link>
            <ul v-else style="display: none;"></ul>
          </span>

          <span><router-link to="help" v-if="isLoggedIn">Centre d'aide </router-link>
            <ul v-else style="display: none;"></ul>
        ...
        <div class="buttons" v-if="isLoggedIn">
          <routerLink to="/donate" class="btn btn-danger" style="color: #ffff;">Faire un Don</routerLink>
          <routerLink to="/demande" class="btn" style="background: #00002c;color:#ffff;">Faire une demande</routerLink>
        </div>
        <div class="buttons" v-else>
          <routerLink to="/register" class="btn btn-danger" style="background: green;">S'inscrire</routerLink>
          <routerLink to="/login" class="btn" style="background: #00002c;color:#ffff;">Se connecter</routerLink>
        </div>
      </nav>
    </div>
...
export default {
  ...
  methods: {
    getUsers() {
      axios
        .get(
          "http://127.0.0.1:8000/api/simpleUser/profile",
