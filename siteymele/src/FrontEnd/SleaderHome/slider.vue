<template>
    <!-- Slider Area -->
    <section class="slider" style="max-height: 80vh;">
                ...
                <div class="bg-color">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="text">
                                    <h1>Heureux de <span>vous revoir</span>. Que voulez-vous faire
                                    ...
                                    <div v-if="isLoggedIn" class="button">
                                        ...
                                        <router-link to="demande" class="btn primary" style="background-color: #00002c;">Faire une demande</router-link>
                                    </div>
                                    <div v-else class="button">
                                        <router-link to="register" class="btn" style="background: green;">S'inscrire</router-link>
                                        <router-link to="login" class="btn primary" style="background-color: #00002c;">Se connecter</router-link>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="bg-color">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="text">
                                    <h1>POURQUOI FAIRE <span style="color: red;">DON DE SANG?</span> </h1>
