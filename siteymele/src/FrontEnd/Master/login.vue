        ...
        <div class="forms-bottle">
            <div class="signin-signup">
                ...
                <form action="#" class="sign-in-form" @submit.prevent="login">
                    ...
                    <h2 class="title" style="color: #d32727">Se Connecter</h2>
                    ...
                    <input type="submit" value="Connexion" class="button solid" style="background-color: #d32727"
                        required />
        ...
        <div class="panels-bottle" >
            <div class="panel left-panel">
                <div class="content">
                    <h3>Nouveau ici ?</h3>
                    <p>
                        Alors nous vous invitons a vous inscrire gratuitement et faire votre premier don!
                    </p>
...
export default {
  ...
  methods: {
   login() {
                ...
                axios.post('http://127.0.0.1:8000/api/site/login', {
                    email: this.email,
...
.bottle {
  ...
  .bottle-login:before {
    ...
    background-image: linear-gradient(-45deg,#871515 25%, #ad1515 70%) ;
