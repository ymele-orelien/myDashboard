  ...
  <div class="bottle">
    ...
    <div class="panels-bottle">
      <div class="panel left-panel">
        <div class="content">
          <h3 class="text-white">Nouveau ici ?</h3>
          <p class="text-white">
              Alors nous vous invitons a vous inscrire gratuitement et a faire soit votre premier don soit votre premiere demande de poche de sang!
          </p>
   ...
   login() {
                ...
                axios.post('http://127.0.0.1:8000/api/site/login', {
                    ...
                    console.log([this.email,this.password,response.data])
						this.$toast.info('heureux de vou revoir !');

                    this.$router.push('/')
           
                }).catch((errors) => {
                    console.log(errors)
						this.$toast.warning('EMAIL OU MOT DE PASSE INCORRECTE!');
